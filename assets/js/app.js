                  ...
                  fetchData(url.geo(searchField.value), function (locations) {
                        ...
                        for (const { name, lat, lon, country, state } of locations) {
                              ...
                              searchItem.innerHTML = `
                                    ...
                                    <a href="#/weather?lat=${lat}&lon=${lon}" aria-label="${name} weather" class="has-state item-link" data-search-toggler></a>
                              `;
      ...
      fetchData(url.currentWeather(lat, lon), function (currentWeather) {
            ...
            card.innerHTML = `
                  ...
                  <div class="wrapper">
                        ...
                        height="64" width="64" class="weather-icon">
                  </div>
                                    ...
                                    <div class="wrapper">
                                          ...
                                          <ul class="card-list">
                                                <li class="card-item">
                                                      ...
                                                      <p class="label-1">PM <sub>2_5</sub></p>
                                                </li>
                                                <li class="card-item">
            ...
            fetchData(url.forecast(lat, lon), function(forecast) {
                  ...
                  <div class="slider-container">
                        ...
                        <ul class="slider-list" data-wild></ul>
                  </div>
                  `
                  for(const [index, data] of forecastList.entries()) {
                        ...
                        tempLi.innerHTML = `
                              <div class="card card-sm slider-card">
                                    ...
                                    width="48" height="48" loading="lazy" title="${description}" alt="${description}" class="weather-icon" >
                        ...
                        windLi.innerHTML = `
                              <div class="card card-sm slider-card">
                                    ...
                                    width="48" height="48" loading="lazy" style="transform: rotate(${windDirection - 180}deg)" alt="direction" class="weather-icon" >
                                    <p class="body-3">${parseInt(module.mps_to_kmh(windSpeed))} km/h</p>
                              </div>
                        `
                        hourlySection.querySelector("[data-wild]").appendChild(windLi);
                  }
                  forecastSection.innerHTML = `
